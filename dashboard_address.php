                    ...
                    <div class="col-xl-3 col-lg-4 wow fadeInUp" data-wow-duration="1s">
                        <div class="dashboard_menu">
                            ...
                            <ul>
                                ...
                                <li><a class="active" href="dashboard_address.php"><span><i
                    ...
                    <div class="col-xl-9 col-lg-8 wow fadeInUp" data-wow-duration="1s">
                        <div class="dashboard_content">
                            <div class="dashboard_body address_body">
                                <h3>address <a class="dash_add_new_address" href="dashboard_address_new.php">add
                                        new</a>
                                </h3>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="checkout_single_address">
                                                    ...
                                                    <ul>
                                                        <li><a href="dashboard_address_edit.php"><i
