        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="menu_icon d-flex flex-wrap">
                    ...
                    <li>
                        <a class="active" href="dashboard.php"><i class="fas fa-user"></i></a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-4 wow fadeInUp" data-wow-duration="1s">
                        <div class="dashboard_menu">
                            ...
                            <ul>
                                <li><a href="dashboard.php"><span><i class="fas fa-user"></i></span> Parsonal Info</a>
                                </li>
                                <li><a href="dashboard_address.php"><span><i class="fas fa-user"></i></span>address</a>
                                </li>
                                <li><a class="active" href="dashboard_order.php"><span><i
                                                class="fas fa-bags-shopping"></i></span>
                                        Order</a></li>
                                <li><a href="dashboard_wishlist.php"><span><i class="far fa-heart"></i></span>
                                        wishlist</a></li>
                                <li><a href="dashboard_review.php"><span><i class="fas fa-star"></i></span> Reviews</a>
                                </li>
                                        ...
                                        <table class="table">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="dashboard_order_invoice.php">View Details</a></td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <h5>#2457945235</h5>
